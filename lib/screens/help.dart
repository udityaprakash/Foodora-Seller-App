          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                SizedBox(height: 10),
                textgenerator('Archas - 9745863556', 15, 'Raleway', 300, Colors.white),
                SizedBox(height: 10),
                textgenerator('Anshuman - 8587358767', 15, 'Raleway', 300, Colors.white),
                SizedBox(height: 10),
                textgenerator('Ishika - 7536465347', 15, 'Raleway', 300, Colors.white),
                SizedBox(height: 10),
                textgenerator('Harshit - 6357675723', 15, 'Raleway', 300, Colors.white),
                ]),
              ),
            ],
          ),
